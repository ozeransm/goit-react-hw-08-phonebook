...
const AddNewContact = ()=>{
    ...
    return(
        <Box w='90%' ml='auto' mr='auto' mb='10px' display='flex' flexWrap='wrap' alignItems="center" justifyContent="center" bg='lightBlue' borderRadius='md' p={4} color='white'>
        ...
        <FormControl display='flex' flexWrap='wrap' >
            ...
            <Input name="name" id="name" onChange={handlerChange} value={name} type='text' color='grey' placeholder='Name' w='100' ml='3'/>
            
            <Input name="phone" id="phone" onChange={handlerChange} value={number} type='text' color='grey' placeholder='Phone Number' w='100' ml='3'/>
